<template>
	<div class="pt-24">
		<div class="container">
			...
			<div class="grid grid-cols-3 gap-x-16 gap-y-28 mt-20 lg:grid-cols-1 pb-28">
				<div v-for="i in 5">
					<h2 class="text-4xl tracking-rr font-extralight lg:text-3xl">Дизайнер Tilda</h2>
					<hr class="h-px mb-6 mt-4 bg-gray-500 w-10">
					<p class="text-gray-400 leading-normal tracking-widest font-extralight">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	...
	export default {
		methods: {
			async fetchSomething() {
				await this.$axios.$post('/order-call.php')
			}
		},
		mounted () {
			this.fetchSomething()
