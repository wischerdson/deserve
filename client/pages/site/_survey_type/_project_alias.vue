		...
		<section class="pb-16" v-if="survey">
			<div class="container-lg">
				...
				<p class="mt-6 text-lg">
					Здравствуйте<span v-if="clientName">, {{ clientName }}</span>, мы очень рады, что Вы с нами. Команда <a class="underline font-normal text-blue-500" href="https://psyweb.site" target="_blank">psyweb.site</a> подготовила для Вас личный кабинет. Здесь находится брифинг, данные из которого будут использованы для дальнейшей разработки Вашего сайта. Пожалуйста, заполните все поля форм, которые позволят нам качественно разработать Ваш будущий сайт. Во время разработки Вы всегда можете зайти на эту страницу и изменить или добавить что-либо (не забудьте нажать кнопку "Сохранить"). Если у Вас возникнут вопросы Вы всегда можете обратиться к Вашему личному менеджеру в <a class="underline text-green-500 font-normal" href="https://wa.me/79101127174?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5%2C%20%D1%83%20%D0%BC%D0%B5%D0%BD%D1%8F%20%D0%B5%D1%81%D1%82%D1%8C%20%D0%B2%D0%BE%D0%BF%D1%80%D0%BE%D1%81" target="_blank">WhatsApp</a>
				</p>
			</div>
		</section>
...
export default {
	...
	async fetch () {
		...
		await getSurvey(surveyType, this.projectName).then(({ data }) => {
			...
			this.clientName = this.$route.query.client || this.project.name
		})
	},
	fetchOnServer: false,
	data () {
